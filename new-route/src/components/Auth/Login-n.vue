<template>
    <v-container fluid fill-height> <!--{ ortalamak için kullanıyoruz }-->
        <v-layout align-center justify-center>   <!--{ ortalamak için kullanıyoruz }-->
            <v-flex xs12 sm18 md4>  <!--{ v-flex is used for columns xs12(ekstra small) sm8(8 columns)   }-->
                <v-form>
                    <v-card class="elevation-12"> <!--{ elevation: gölgenin yumuşaklığını ayarlıyor }-->
                        ...
                        <v-divider></v-divider>
                        <v-card-actions>
                            <v-btn to="/signup" dark color="indigo" round>Sign up</v-btn>
                            ...
                            <div class="text-center">
                                ...
                                <v-card>
                                    <v-toolbar color="blue" dark dense class="text-h5"> <!--{ dark yazı rengini açık yapıyor tema dark olduğunda kullanılıyor olmalı }-->
                ...
                <v-btn top small color="blue" depressed>A</v-btn>
            </v-flex>
        </v-layout>
    </v-container>
</template>
